...
$(function () {
    ...
    $(".js-owl-cartoons").owlCarousel({
        ...
        navigationText: ['<img src="/static/images/prev-button.png">', '<img src="/static/images/next-button.png">'],
        slideSpeed: 300,
        paginationSpeed: 400,
        singleItem: true
    ...
    $(".js-owl-list-hundred, .js-owl-list-thousand, .js-owl-list-all, .js-owl-list-profile").owlCarousel({
        navigation: true, // Show next and prev buttons
        navigationText: ['<img src="/static/images/prev-btn-blue.png">', '<img src="/static/images/next-btn-blue.png">'],
        slideSpeed: 300,
        paginationSpeed: 400,
        singleItem: true
    });
